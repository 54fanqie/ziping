//
//  CYJIrregularityContrntView.swift
//  ZiPingSwift
//
...
class CYJBasicContentView: ESTabBarItemContentView {
...
class CYJIrregularityContentView: ESTabBarItemContentView {

    override init(frame: CGRect) {
        super.init(frame: frame)
        
        self.imageView.backgroundColor = UIColor(hex6: 0x428cc1)//UIColor.init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
//        self.imageView.layer.borderWidth = 3.0
//        self.imageView.layer.theme_borderColor = "Global.textColorLight"
        self.imageView.layer.cornerRadius = 22.5
        self.insets = UIEdgeInsetsMake(-22, 0, 0, 0)
        let transform = CGAffineTransform.identity
        self.imageView.transform = transform
        self.superview?.bringSubview(toFront: self)
        renderingMode = .alwaysOriginal
        textColor = UIColor(hex6: 0xAAD3F0) //UIColor.init(white: 255.0 / 255.0, alpha: 1.0)
        highlightTextColor = UIColor(hex6: 0xAAD3F0) //UIColor.init(white: 255.0 / 255.0, alpha: 1.0)
